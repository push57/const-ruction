...
const Services = () => {
  return (
    <div id="services" className='w-full bg-white'>
      ...
      <motion.h1 variants={slideUpVariants} className='text-black-[42px] font-bold text-3xl' >OUR BEST SERVICES</motion.h1>
      ...
      className='flex justify-center items-start gap-5 p-8'
          ...
          className='w-[60px] border-2 border-yellow-500 hover:bg-yelloe-500 rounded-lg p-2' />
